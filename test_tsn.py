...
# model = '/home/a/Desktop/NTUA-BEEU-eccv2020-master/log/models/rgb_with_context_tsn/0322_084119/model_best.pth'
# python test_tsn.py --mode test --modality "RGB" --arch resnet101 --workers 4 --context --weights /home/a/Desktop/NTUA-BEEU-eccv2020-master/log/models/rgb_with_context_tsn/0322_084119/model_best.pth
# python test_tsn.py --mode val --modality "RGB" --arch resnet101 --workers 4 --context --weights /home/a/Desktop/NTUA-BEEU-eccv2020-master/log/models/rgb_with_context_tsn/0322_084119/model_best.pth
...
def eval_video(video_data):
    ...
    input_var1 = torch.autograd.Variable(data1.view(-1, length_1, data.size(2), data.size(3)),
                                        volatile=True)
    input_var2 = torch.autograd.Variable(stgcndata,
                                        volatile=True)

    out, _ = net(input_var, input_var1, input_var2, None, None)
