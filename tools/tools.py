...
def auto_padding_stgcn(data_numpy, size, random_pad=False):
    C, T, V, M = data_numpy.shape
    if T < size:
...
def random_choose_stgcn(data_numpy, size, auto_pad=True):
    # input: C,T,V,M
    C, T, V, M = data_numpy.shape
    if T == size:
        return data_numpy
...
def random_move_stgcn(data_numpy,
...
def random_shift_stgcn(data_numpy):
    # input: C,T,V,M
    C, T, V, M = data_numpy.shape
